...
class JsonLoaderTest extends TestCase
{
    ...
    public function test_json_loader_writes_array_format()
    {
    ...
    public function test_json_loader_with_pretty_print()
    {
        $loader = JsonLoader::make($this->testFile)
            ->setPrettyPrint(true)
    ...
    public function test_json_loader_as_ndjson()
    {
        $loader = JsonLoader::make($this->testFile)
            ->asNdjson();
    ...
    public function test_json_loader_configuration()
    {
        $loader = JsonLoader::make($this->testFile);
    ...
    public function test_json_loader_handles_special_characters()
    {
        $loader = JsonLoader::make($this->testFile)
            ->forWebApi();
